...
using Tests.Testing.Values;

namespace Tests.Testing
{
    public class InspectablePersistenceSpecification<T> : PersistenceSpecification<T>
    {
        public InspectablePersistenceSpecification(ISessionFactory sessionFactory) : base(sessionFactory)
        { }

        public InspectablePersistenceSpecification(ISessionFactory sessionFactory, IEqualityComparer entityEqualityComparer) : base(sessionFactory, entityEqualityComparer)
        { }
